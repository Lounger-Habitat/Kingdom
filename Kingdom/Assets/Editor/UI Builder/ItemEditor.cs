...
public class ItemEditor : EditorWindow
{
    ...
    private void GetItemDetails()
    {
        ...
        //预制体的绑定
        itemDetailsSection.Q<ObjectField>("ItemPrefab").value = activeItem.itemPrefab;
        itemDetailsSection.Q<ObjectField>("ItemPrefab").RegisterValueChangedCallback(evt =>
        {
            activeItem.itemPrefab = (GameObject)evt.newValue;
        });
        //其他所有变量的绑定
